"""
Django settings for distributors-backend project.
...
APP_NAME = os.getenv("APP_NAME", "distributors-backend")
...
MIDDLEWARE = [
    'distributors-backend.middleware.healthcheckmiddleware.HealthCheckMiddleware',
    ...
    'distributors-backend.middleware.metricsmiddleware.MetricsMiddleware',
]

ROOT_URLCONF = 'distributors-backend.urls'
...
WSGI_APPLICATION = 'distributors-backend.wsgi.application'
